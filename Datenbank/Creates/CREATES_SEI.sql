...
--------------------------------------------------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "WS20_BIF_3D1_1_fbv_00006" ON "MANNSCHAFT_MATCH" ("MATCHID","MANNSCHAFTID");
  CREATE UNIQUE INDEX "WS20_BIF_3D1_1_fbv_00007" ON "MANNSCHAFT_TRAINER" ("TRAINERID" ,"MANNSCHAFTID" );
  CREATE UNIQUE INDEX "WS20_BIF_3D1_1_fbv_00008" ON "MATCH_SCHIEDSRICHTER" ("MATCHID" ,"SCHIEDRICHTERID");
...
--  Mannschaft_Match
--------------------------------------------------------
  ALTER TABLE "MANNSCHAFT_MATCH" MODIFY ("MATCHID" NOT NULL ENABLE);
  ALTER TABLE "MANNSCHAFT_MATCH" MODIFY ("MANNSCHAFTID" NOT NULL ENABLE);
  ALTER TABLE "MANNSCHAFT_MATCH" ADD PRIMARY KEY ("MATCHID","MANNSCHAFTID") ENABLE;
--------------------------------------------------------
--  Mannschaft_Trainer
--------------------------------------------------------
  ...
  ALTER TABLE "MANNSCHAFT_TRAINER" ADD PRIMARY KEY ("TRAINERID","MANNSCHAFTID") ENABLE;
--------------------------------------------------------
--  Match_Schiedsrichter
--------------------------------------------------------
  ALTER TABLE "MATCH_SCHIEDSRICHTER" MODIFY ("MATCHID" NOT NULL ENABLE);
  ALTER TABLE "MATCH_SCHIEDSRICHTER" MODIFY ("SCHIEDRICHTERID" NOT NULL ENABLE);
  ALTER TABLE "MATCH_SCHIEDSRICHTER" ADD PRIMARY KEY ("MATCHID","SCHIEDRICHTERID") ENABLE;
--------------------------------------------------------
--  Match
--------------------------------------------------------
...
--  Mannschaft_Match
--------------------------------------------------------
 ALTER TABLE "MANNSCHAFT_MATCH" ADD FOREIGN KEY ("MANNSCHAFTID")
...
--------------------------------------------------------
 ...
 ALTER TABLE "MATCH_SCHIEDSRICHTER" ADD FOREIGN KEY ("SCHIEDRICHTERID")
