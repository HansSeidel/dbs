...
--------------------------------------------------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "WS20_BIF_3D1_1_fbv_00006" ON "MANNSCHAFT_MATCH" ("MANNSCHAFTID","MATCHID");
...
--------------------------------------------------------
  ...
  ALTER TABLE "MANNSCHAFT_MATCH" ADD PRIMARY KEY ("MANNSCHAFTID", "MATCHID") ENABLE;
--------------------------------------------------------
--  Mannschaft_Trainer
--------------------------------------------------------
